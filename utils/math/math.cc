...
template Vector<float, 2u> operator/(const Vector<float, 2u> value, const float factor);
...
template Vector<float, 3u> operator/(const Vector<float, 3u> value, const float factor);
...
template Vector<float, 4u> operator/(const Vector<float, 4u> value, const float factor);
